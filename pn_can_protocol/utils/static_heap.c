...
struct HeapControl StaticHeap = { .init = init, .malloc = allocate, .free = deallocate, .printMemory = printMemory, .printMemoryMap = printMemoryMap, .print = print, .getAvailableBytes = getAvailableBytes, .getAvailableAllocatableBytes = getAvailableAllocatableBytes, .getAvailableNumberOfAllocation = getAvailableNumberOfAllocation };
